...
setr = 23
wl1 = 24
GPIO.setup(setr, GPIO.IN)
GPIO.setup(wl1, GPIO.OUT)
GPIO.output(wl1, False)
...
def sendata():
	...
	GPIO.output(set, True) #Sends out status light
	GPIO.output(4, True)
	GPIO.output(24, True)
